...
class CustomCursor {
    ...
    init() {
        ...
        console.log('✅ Spaceship cursor initialized');
    }
    ...
    createSpaceshipCursor() {
        ...
        this.spaceship.innerHTML = `
            <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Top tip -->
                <rect x="14" y="4" width="4" height="4" fill="#9f55ff"/>
                
                <!-- Upper body -->
                <rect x="10" y="8" width="4" height="4" fill="#8b31ff"/>
                <rect x="14" y="8" width="4" height="4" fill="#9f55ff"/>
                <rect x="18" y="8" width="4" height="4" fill="#8b31ff"/>
                
                <!-- Mid body -->
                <rect x="10" y="12" width="4" height="4" fill="#8b31ff"/>
                <rect x="14" y="12" width="4" height="4" fill="#9f55ff"/>
                <rect x="18" y="12" width="4" height="4" fill="#8b31ff"/>
                
                <!-- Wings -->
                <rect x="6" y="16" width="4" height="4" fill="#7000ff"/>
                <rect x="10" y="16" width="4" height="4" fill="#8b31ff"/>
                <rect x="14" y="16" width="4" height="4" fill="#9f55ff"/>
                <rect x="18" y="16" width="4" height="4" fill="#8b31ff"/>
                <rect x="22" y="16" width="4" height="4" fill="#7000ff"/>
                
                <!-- Engine base -->
                <rect x="10" y="20" width="4" height="4" fill="#8b31ff"/>
                <rect x="14" y="20" width="4" height="4" fill="#9f55ff"/>
                <rect x="18" y="20" width="4" height="4" fill="#8b31ff"/>
    ...
    shootLaser(x, y) {
        // Create 3 laser beams for more visible effect
        for (let i = 0; i < 3; i++) {
            setTimeout(() => {
                const laser = document.createElement('div');
                laser.className = 'shoot-particle';
                laser.style.left = `${x + (Math.random() - 0.5) * 6}px`;
        ...
        // Create bigger explosion at click point
        this.createExplosion(x, y);
    }

    createExplosion(x, y) {
        // Create multiple explosion particles (more particles!)
        for (let i = 0; i < 16; i++) {
    ...
    createTrailParticle(x, y) {
        ...
        let posY = y;
        let posX = x;
        let velocityY = 0.5; // Start falling down slowly
        let velocityX = (Math.random() - 0.5) * 1.5; // Random sideways drift
        
        const fadeOut = () => {
            opacity -= 0.035;
            size -= 0.2;
            posY += velocityY; // Move down
            posX += velocityX; // Drift sideways
            velocityY += 0.18; // Accelerate downward (gravity effect)
    ...
    animate() {
        ...
        // Create trail particles CONTINUOUSLY (simulating always-on engine)
        // Higher spawn rate - almost every frame for thick smoke effect
        if (Math.random() > 0.3) {
            // Trail appears behind the spaceship (adjusted for tilt)
            // Multiple spawn points for thicker smoke
        ...
        // Add extra smoke particles for denser effect when idle
        if (Math.random() > 0.6) {
            const spawnX = this.cursorX + (Math.random() - 0.5) * 10 + 6;
            const spawnY = this.cursorY + 20 + Math.random() * 6;
            this.createTrailParticle(spawnX, spawnY);
        }
